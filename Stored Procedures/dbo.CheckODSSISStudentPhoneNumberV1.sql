...
-------------------------------------------------------------------------------
CREATE   PROCEDURE [dbo].[CheckODSSISStudentPhoneNumberV1]
AS
BEGIN
...
INTO #tempodsphn
FROM Edfi_student a
INNER  JOIN Edfi_StudentEducationOrganizationAssociation seo ON a.StudentUSI = seo.StudentUSI
INNER JOIN Edfi_StudentEducationOrganizationAssociationTelephone t ON a.StudentUSI = t.StudentUSI AND t.EducationOrganizationId = seo.EducationOrganizationId
INNER JOIN Edfi_StudentSchoolAssociation sc ON a.StudentUSI = sc.StudentUSI
