...
CREATE   PROCEDURE [dbo].[CheckODSSISGradingPeriodV1]
AS
BEGIN
    SET NOCOUNT ON;
    SELECT School_ID,
    ...
    (
        ...
        SELECT DISTINCT
			   ...
			   'SIS' as RecordsFoundIn
        FROM EdFi_GradingPeriod gp
            INNER JOIN EdFi_Descriptor d
                ON d.DescriptorId = gp.GradingPeriodDescriptorId
            INNER JOIN EdFi_EducationOrganization eo
