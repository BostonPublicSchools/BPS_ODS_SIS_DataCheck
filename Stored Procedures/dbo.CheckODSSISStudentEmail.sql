...
-------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[CheckODSSISStudentEmail]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM s3v5ys_EdFi_BPS_ProdYS_Ods_2023.edfi.Student a
        INNER JOIN s3v5ys_EdFi_BPS_ProdYS_Ods_2023.edfi.StudentEducationOrganizationAssociation seo
            ON a.StudentUSI = seo.StudentUSI
        INNER JOIN s3v5ys_EdFi_BPS_ProdYS_Ods_2023.edfi.StudentEducationOrganizationAssociationElectronicMail b
            ON a.StudentUSI = b.StudentUSI
        LEFT JOIN s3v5ys_EdFi_BPS_ProdYS_Ods_2023.edfi.StudentSchoolAssociation eo WITH (NOLOCK)
